...
// use crate::utils::{get_system_time_ms, get_system_time_ms_gstr, gstr_to_millis};
// use crate::Network;
...
//     remote_ts: GString,
// ) -> Result<(), ()> {
//     let current_local_ms = get_system_time_ms();
//     let origin_ms = gstr_to_millis(origin_ts);
//     let remote_ms = gstr_to_millis(remote_ts);

//     let peer = gr3d.network.get_remote_peer_mut(peer_id).ok_or(())?;
//     peer.last_ping_received = current_local_ms;
//     peer.rtt = current_local_ms - remote_ms;

//     let lf = origin_ms as f64;
//     let rf = remote_ms as f64;
