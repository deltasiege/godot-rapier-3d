# https://github.com/Zylann/godot_debug_draw/blob/master/addons/zylann.debug_draw/debug_draw.gd
extends CanvasLayer

const DebugDrawFont = preload("res://addons/debug_draw/Hack-Regular.ttf")
